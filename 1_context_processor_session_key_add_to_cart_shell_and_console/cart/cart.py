...
"""
    ...
    'session_key': {'2': {'price': '119.99'}, '4': {'price': '100.99'}}}


    >>> from django.contrib.sessions.models import Session
    >>> s_k = Session.objects.get(pk='wzukk8nzh1ejwe7r0aojcwpkvuqekose')
    >>> s_k.get_decoded()
    {'session_key': {'3': {'price': '99.99'}, '2': {'price': '119.99'}, '4': {'price': '100.99'}}}
